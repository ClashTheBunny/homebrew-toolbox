class Toolbox < Formula
  ...
  def install
    ...
    mkdir "build" do
      puts "meson", "-Drun_postinst=false", "-Dprofile_dir=#{HOMEBREW_PREFIX}/etc/profile.d", "-Dtmpfiles_dir=#{HOMEBREW_PREFIX}/etc/tmpfiles.d/", *std_meson_args, ".."
      system "meson", "-Drun_postinst=false", "-Dprofile_dir=#{prefix}/etc/profile.d", "-Dtmpfiles_dir=#{HOMEBREW_PREFIX}/etc/tmpfiles.d", *std_meson_args, ".."
      system "ninja", "-v"
